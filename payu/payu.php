...
class payu extends PaymentModule 
{
    ...
    {
        if (!parent::install()
                OR !Configuration::updateValue('PAYU_POSID', '')
                OR !Configuration::updateValue('PAYU_POSAUTHKEY', '')
                OR !Configuration::updateValue('PAYU_AUTHKEY1', '')
                OR !Configuration::updateValue('PAYU_AUTHKEY2', '')
    ...
    {
        if (!Configuration::deleteByName('PAYU_POSID')
                OR !Configuration::deleteByName('PAYU_POSAUTHKEY')
                OR !Configuration::deleteByName('PAYU_AUTHKEY1', '')
                OR !Configuration::deleteByName('PAYU_AUTHKEY2', '')
                OR !parent::uninstall())
            return false;
